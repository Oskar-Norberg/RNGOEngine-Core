...
namespace RNGOEngine::Resources
{
    void ResourceTracker::MarkModelLastUsed(
        const Containers::GenerationalKey<MeshResource>& modelKey, const size_t frame)
    {
    ...
    void ResourceTracker::MarkTextureLastUsed(
        const Containers::GenerationalKey<Core::Renderer::TextureID>& textureKey, const size_t frame)
    {
